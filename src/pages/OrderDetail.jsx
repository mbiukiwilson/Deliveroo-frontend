    ...
    <main className="page container">
      ...
      <div className="detail-grid">
        ...
        <section className="map-card">
          {pickup && destinationPoint ? <MapTracker pickup={pickup} destination={destinationPoint} current={current} live={parcel.status === "in_transit"} onRoute={() => {}} /> : <div className="map-placeholder"><div className="map-label">Add a Google Maps API key to enable live tracking.</div></div>}
